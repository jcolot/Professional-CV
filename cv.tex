...
\begin{tabular}{rl}
    \textsc{Place and Date of Birth:} & Brussels, Belgium  | 26 August 1979 \\
    \textsc{Address:}   & Rue Froissar 3, 1040, Etterbeek, Belgium \\
    \textsc{Phone:}     & +32 490 45 06 88 \\
    \textsc{email:}     & \href{mailto:julien.colot@gmail.com}{julien.colot@gmail.com}
\end{tabular}

%Section: Work Experience at the top
\section{Work Experience}
\begin{tabular}{r|p{11cm}}
 \emph{Current} & System Engineer at \textsc{Orange Cyberdefense Belgium}\\\textsc{Jan 2017}&\emph{Infrastructure Maintenance and Development}\\&\footnotesize{Maintenance of infrastructure physical servers, virtual machines and Docker containers. Development of scripts to automate tasks for SOC Engineers. Main developer and administrator of the ServiceNow instances}\\\multicolumn{2}{c}{} \\
...
\section{Education}
\begin{tabular}{rl}	
 \textsc{June} 2018 & Bachelor of Science in \textsc{Computer Science}, \textbf{Université de Namur}, Namur\\
& \small\emph{Avec distinction}\\
& Bachelor thesis: ``Blockchain for the Supply Chain'' | \small Advisor: Prof. Philippe \textsc{Thiran}\\
&\normalsize \textsc{Gpa}: 15.5/20\hyperlink{grds}{\hfill | \footnotesize Detailed List of Exams}\\&\\
\end{tabular}
